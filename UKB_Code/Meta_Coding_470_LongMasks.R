...
time <- system.time({
  ...
  # for array in {1..2};
  # do
  # dx run app-swiss-army-knife -iin=UKB_PRS:JW/Software/r_with_plink.tar.gz -iin=UKB_PRS:MetaSTAAR/Scripts/Meta_Coding_470_LongMasks.R -iin=UKB_PRS:MetaSTAAR/Scripts/Meta_Coding_470_LongMasks.sh -icmd="bash Meta_Coding_470_LongMasks.sh ${array}" -y --destination UKB_PRS:MetaSTAAR/Results_470/ --priority low --extra-args '{"executionPolicy":{"maxSpotTries":5,"spotOnly":true}}' --instance-type mem3_ssd1_v2_x32
  # done
  ...
  ###########################################################
  ## Null model
  obj_nullmodel <- get(load("obj.STAAR.UKB.TC.20240707.Rdata"))
  agds_dir <- paste0("ukb.470k.wes.chr",1:22,".pass.annotated.gds")
  ...
  save(coding_sumstat,file=paste0(output_file_name,"_sumstat_",arrayid_longmask+379,"_470.Rdata"),compress = "xz")
  save(coding_cov,file=paste0(output_file_name,"_cov_",arrayid_longmask+379,"_470.Rdata"),compress = "xz")
...
save(time,file = paste0(output_file_name,"_time_",arrayid_longmask+379,"_470.Rdata"))