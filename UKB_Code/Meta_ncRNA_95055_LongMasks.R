...
time <- system.time({
  ...
  # dx run app-swiss-army-knife -iin=UKB_PRS:JW/Software/r_with_plink.tar.gz -iin=UKB_PRS:MetaSTAAR/Scripts/Meta_ncRNA_95055_LongMasks.R -iin=UKB_PRS:MetaSTAAR/Scripts/Meta_ncRNA_95055_LongMasks.sh -icmd="bash Meta_ncRNA_95055_LongMasks.sh" -y --destination UKB_PRS:MetaSTAAR/Results_95055/ --priority low --extra-args '{"executionPolicy":{"maxSpotTries":5,"spotOnly":true}}' --instance-type mem3_ssd1_v2_x16
  ...
  save(ncRNA_sumstat,file=paste0(output_file_name,"_sumstat_",223,"_95055.Rdata"),compress = "xz")
  save(ncRNA_cov,file=paste0(output_file_name,"_cov_",223,"_95055.Rdata"),compress = "xz")
})[3]

save(time,file = paste0(output_file_name,"_time_",223,"_95055.Rdata"))