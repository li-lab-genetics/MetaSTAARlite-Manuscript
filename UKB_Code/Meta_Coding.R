...
time <- system.time({
  ...
  # for array in {1..379};
  # do
  # dx run app-swiss-army-knife -iin=UKB_PRS:JW/Software/r_with_plink.tar.gz -iin=UKB_PRS:MetaSTAAR/Scripts/Meta_Coding.R -iin=UKB_PRS:MetaSTAAR/Scripts/Meta_Coding.sh -icmd="bash Meta_Coding.sh ${array}" -y --destination UKB_PRS:MetaSTAAR/Results/ --priority low --extra-args '{"executionPolicy":{"maxSpotTries":5,"spotOnly":true}}' --instance-type mem3_ssd1_v2_x4
  # done
