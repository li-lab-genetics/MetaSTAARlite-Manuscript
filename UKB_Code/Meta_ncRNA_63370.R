...
time <- system.time({
  ...
  # for array in {1..222};
  # do
  # dx run app-swiss-army-knife -iin=UKB_PRS:JW/Software/r_with_plink.tar.gz -iin=UKB_PRS:MetaSTAAR/Scripts/Meta_ncRNA_63370.R -iin=UKB_PRS:MetaSTAAR/Scripts/Meta_ncRNA_63370.sh -icmd="bash Meta_ncRNA_63370.sh ${array}" -y --destination UKB_PRS:MetaSTAAR/Results_63370/ --priority low --extra-args '{"executionPolicy":{"maxSpotTries":5,"spotOnly":true}}' --instance-type mem3_ssd1_v2_x2
  # done
  ...
  save(ncRNA_sumstat,file=paste0(output_file_name,"_sumstat_",arrayid,"_63370.Rdata"),compress = "xz")
  save(ncRNA_cov,file=paste0(output_file_name,"_cov_",arrayid,"_63370.Rdata"),compress = "xz")
