...
time <- system.time({
  ...
  # for array in {1..2};
  # do
  # dx run app-swiss-army-knife -iin=UKB_PRS:JW/Software/r_with_plink.tar.gz -iin=UKB_PRS:MetaSTAAR/Scripts/Meta_Coding_63370_LongMasks.R -iin=UKB_PRS:MetaSTAAR/Scripts/Meta_Coding_63370_LongMasks.sh -icmd="bash Meta_Coding_63370_LongMasks.sh ${array}" -y --destination UKB_PRS:MetaSTAAR/Results_63370/ --priority low --extra-args '{"executionPolicy":{"maxSpotTries":5,"spotOnly":true}}' --instance-type mem3_ssd1_v2_x8
  # done
  ...
  save(coding_sumstat,file=paste0(output_file_name,"_sumstat_",arrayid_longmask+379,"_63370.Rdata"),compress = "xz")
  save(coding_cov,file=paste0(output_file_name,"_cov_",arrayid_longmask+379,"_63370.Rdata"),compress = "xz")
  
  system("rm obj.STAAR.UKB.TC.20240530.63370.Rdata")
...
save(time,file = paste0(output_file_name,"_time_",arrayid_longmask+379,"_63370.Rdata"))