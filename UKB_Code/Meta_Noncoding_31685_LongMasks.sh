...
dx download UKB_PRS:MetaSTAAR/Null_Models/obj.STAAR.UKB.TC.20240530.31685.Rdata
...
docker run -v $PWD:/data -w /data --entrypoint /bin/bash r_with_plink -l -c "Rscript Meta_Noncoding_31685_LongMasks.R ${1}"