...
time <- system.time({
  ...
  # for array in {1..2};
  # do
  # dx run app-swiss-army-knife -iin=UKB_PRS:JW/Software/r_with_plink.tar.gz -iin=UKB_PRS:MetaSTAAR/Scripts/Meta_Coding_LongMasks.R -iin=UKB_PRS:MetaSTAAR/Scripts/Meta_Coding_LongMasks.sh -icmd="bash Meta_Coding_LongMasks.sh ${array}" -y --destination UKB_PRS:MetaSTAAR/Results/ --priority low --extra-args '{"executionPolicy":{"maxSpotTries":5,"spotOnly":true}}' --instance-type mem3_ssd1_v2_x16
  # done
